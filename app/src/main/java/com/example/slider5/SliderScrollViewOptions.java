...
//public class SliderScrollViewOptions {
//
//    private static SliderScrollViewOptions instance;
//
//  //  private final String KEY_TRANSITION_TIME;
//
//    public static void init(Context context) {
//        instance = new SliderScrollViewOptions(context);
//    }
//
//    private SliderScrollViewOptions(Context context) {
...
//        return PreferenceManager.getDefaultSharedPreferences(SliderApp.getInstance());
//    }
//
